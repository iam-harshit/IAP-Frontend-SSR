  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      window.location.replace(
        'https://community.curiousdevelopers.in/register/'
      );
    }, 3000);
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-gradient-to-br from-purple-500 to-indigo-800 h-screen text-white">
      <div className="text-center mb-6">
        <h1 className="text-3xl font-bold mb-2">Redirecting to Sign Up...</h1>
        <p className="text-lg opacity-90">
          Hang tight, setting up your registration journey...
        </p>
      </div>
