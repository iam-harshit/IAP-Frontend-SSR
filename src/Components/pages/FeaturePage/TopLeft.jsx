...
const TopLeft = () => {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 pb-16 text-center lg:pt-20">
      {/* Intro Text */}
      <p className="mx-auto -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
        Built For{' '}
        <span className="border-b border-dotted border-slate-300">You</span>
      </p>
      ...
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        <span className="inline-block">
          ...
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative">with IAP</span>
          </span>
        </span>{' '}
